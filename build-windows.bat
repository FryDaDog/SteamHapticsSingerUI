...
REM build.bat
REM
REM builds steam_haptics_singer_ui.py into a standalone .exe
...
set APP_NAME=steam-haptics-singer-ui
set ENTRYPOINT=steam_haptics_singer_ui.py
set VENV=.venv
